...
const routes = [
    ...
    {
        path: 'pay',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pay_pay_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pay/pay.module */ 59485)).then(m => m.PayPageModule)
    }
];
