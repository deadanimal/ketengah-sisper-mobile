...
let HomePage = class HomePage {
    constructor(router, nativeStorage, alertController, loadingController, notisService, pengumumanService, route, modalController, platform, bookingService, pdfGenerator) {
        ...
        this.platform.backButton.subscribeWithPriority(10, () => {
            /* eslint-disable */ ;
            (oo_oo(), console.log('none', `c2832b91_0`));
        });
    ...
    ngOnInit() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            this.nativeStorage.getItem('user').then((data) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
                let user_id;
                /* eslint-disable */ ;
                (oo_oo(), console.log(data, `c2832b91_1`));
    ...
    ionViewDidEnter() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.nativeStorage.getItem('user').then(data => {
                /* eslint-disable */ ;
                (oo_oo(), console.log(data, `c2832b91_4`));
                ...
                if (this.rumah != undefined) {
                    this.rumah.forEach(element => {
                        ...
                        /* eslint-disable */ ;
                        (oo_oo(), console.log(temp2, `c2832b91_5`));
                ...
                if (this.premis != undefined) {
                    this.premis.forEach(element => {
                        ...
                        /* eslint-disable */ ;
                        (oo_oo(), console.log(temp2, `c2832b91_6`));
                        element.jumlahbyr = temp + temp2;
                    });
                }
                /* eslint-disable */ ;
                (oo_oo(), console.log('rumah', this.rumah, `c2832b91_7`));
                /* eslint-disable */ ;
                (oo_oo(), console.log('premis', this.premis, `c2832b91_8`));
                this.nativeStorage.setItem('user', { value: this.user });
                /* eslint-disable */ ;
                (oo_oo(), console.log(this.user, `c2832b91_9`));
                ...
                if (this.user.role == 1) {
                    ...
                    yield this.notisService.getbyid(this.user.user_id).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
                        ...
                        yield this.notisService.getnotis(this.user).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
                            /* eslint-disable */ ;
                            (oo_oo(), console.log('api', res, `c2832b91_10`));
                            Array.prototype.push.apply(this.notiarr, res);
                            /* eslint-disable */ ;
                            (oo_oo(), console.log('notis', this.notiarr, `c2832b91_11`));
                            yield loading.dismiss();
                        }), (res) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
                            /* eslint-disable */ ;
                            (oo_oo(), console.log(res, `c2832b91_12`));
                            yield loading.dismiss();
                            const alert = yield this.alertController.create({
                                header: 'Loading failed',
                                message: res.message,
                        ...
                        /* eslint-disable */ ;
                        (oo_oo(), console.log(res, `c2832b91_13`));
                        yield loading.dismiss();
                        const alert = yield this.alertController.create({
                            header: 'Loading failed',
                            message: res.message,
                    ...
                    yield this.bookingService.getgraf().subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
                        /* eslint-disable */ ;
                        (oo_oo(), console.log(res, `c2832b91_14`));
                        var book = [];
                        res.forEach(element => {
                            book.push(element);
                        });
                        ...
                        yield this.bookingService.get().subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
                            this.bookdtl = res;
                            /* eslint-disable */ ;
                            (oo_oo(), console.log(this.bookdtl, `c2832b91_15`));
                            yield loading.dismiss();
                        }), (res) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
                            /* eslint-disable */ ;
                            (oo_oo(), console.log(res, `c2832b91_16`));
                            yield loading.dismiss();
                            const alert = yield this.alertController.create({
                                header: 'Loading failed',
                                message: res.message,
                        ...
                        /* eslint-disable */ ;
                        (oo_oo(), console.log(res, `c2832b91_17`));
                        yield loading.dismiss();
                        const alert = yield this.alertController.create({
                            header: 'Loading failed',
                            message: res.message,
                        ...
                        /* eslint-disable */ ;
                        (oo_oo(), console.log("first", `c2832b91_18`));
                        yield alert.present();
                    }));
                }
            }
    ...
    downloadchart() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.pdfGenerator.fromData(content, options)
                .then((base64) => {
                /* eslint-disable */ ;
                (oo_oo(), console.log('OK', base64, `c2832b91_19`));
            }).catch((error) => {
                /* eslint-disable */ ;
                (oo_oo(), console.log('error', error, `c2832b91_20`));
            });
        });
    }
    tambah() {
    ...
    notis() {
        /* eslint-disable */ ;
        (oo_oo(), console.log('notis', this.notiarr, `c2832b91_21`));
    ...
    barChartMethod() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            ...
            var data2 = [];
            /* eslint-disable */ ;
            (oo_oo(), console.log('chart', this.chartdata, `c2832b91_22`));
            this.chartdata.forEach(element => {
                var r = Object.keys(element);
                /* eslint-disable */ ;
                (oo_oo(), console.log('r', r, `c2832b91_23`));
                r.forEach(item => {
                    var today = new Date(item);
                    var dd = String(today.getDate()).padStart(2, '0');
                    var day = today.getDay();
                    /* eslint-disable */ ;
                    (oo_oo(), console.log(day, `c2832b91_24`));
                    if (day == 1) {
                        var hari = 'isnin';
                        var temp = dd + '-' + hari;
                        label.push(temp);
            ...
            /* eslint-disable */ ;
            (oo_oo(), console.log(label, `c2832b91_25`));
            /* eslint-disable */ ;
            (oo_oo(), console.log(data, `c2832b91_26`));
...
let TambahakaunComponent = class TambahakaunComponent {
    constructor(modalController, router, translateService) {
        ...
        /* eslint-disable */ ;
        (oo_oo(), console.log('translation', this.translateService, `c2ca654e_0`));
    }
    ngOnInit() {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (".homemain {\n  background: linear-gradient(180deg, #3D2C7C 0%, #750504 100%);\n  height: 300px;\n}\n\n.iconsisper {\n  height: 25px;\n  width: 20px;\n}\n\n.iconnoti {\n  height: 30px;\n  width: 28px;\n  display: inline-block;\n  margin-right: 0;\n}\n\n.iconnotifalse {\n  height: 25px;\n  width: 22px;\n  display: inline-block;\n  margin-right: 0;\n}\n\n.selamat {\n  font-style: normal;\n  font-weight: 600;\n  font-size: 18px;\n  line-height: 27px;\n  letter-spacing: -0.165px;\n  color: #FFFF00;\n  padding-top: 20px;\n}\n\n.name {\n  font-style: normal;\n  font-weight: 600;\n  font-size: 22px;\n  line-height: 33px;\n  letter-spacing: -0.165px;\n  color: #FFFFFF;\n}\n\n.iconketengah {\n  height: 63px;\n  width: 48px;\n  display: inline-block;\n  margin-right: 0;\n}\n\n.inline {\n  display: inline-block;\n}\n\n.akaunsaya {\n  font-style: normal;\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 24px;\n  letter-spacing: -0.165px;\n  color: #FFFFFF;\n}\n\n.buttontambah {\n  width: 100px;\n  height: 35px;\n  background: #7054D9;\n  font-weight: 500;\n  font-size: 16px;\n  border-radius: 4px;\n  margin-right: 0;\n}\n\n.homemaintwo {\n  margin-top: -50px;\n  background-color: white;\n  border-radius: 40px 40px 0px 0px;\n}\n\n.container2 {\n  padding: 30px 15px 30px 15px;\n}\n\n.card {\n  background: #FFFFFF;\n  box-shadow: 4px 0px 8px rgba(73, 87, 184, 0.2), 0px 4px 8px rgba(73, 87, 184, 0.2);\n  border-radius: 10px;\n}\n\n.card2 {\n  display: inline-block;\n  background: #FFFFFF;\n  border: 1px solid #F7FAFD;\n  box-sizing: border-box;\n  box-shadow: 0px 4px 8px rgba(73, 87, 184, 0.2);\n  border-radius: 10px;\n  width: 90%;\n  height: 135px;\n  padding-top: 10px;\n}\n\n.slider {\n  height: 230px;\n  padding: 10px 20px;\n  background: url(\"/assets/icon/pengumumanback.png\");\n  background-repeat: no-repeat;\n  background-size: cover;\n  background-position: center;\n  text-align: left;\n  display: block;\n  font-style: normal;\n  font-weight: 600;\n  font-size: 15px;\n  line-height: 130%;\n  letter-spacing: -0.165px;\n  color: #FFFFFF;\n}\n\n.cardimg {\n  text-align: center;\n  display: block;\n  margin: auto;\n  margin-top: 15%;\n}\n\n.cardname {\n  font-style: normal;\n  font-weight: 500;\n  font-size: 12px;\n  line-height: 16px;\n  text-align: center;\n  letter-spacing: -0.165px;\n  color: #000000;\n  padding-top: 10px;\n  text-align: center;\n  width: 90px;\n  display: block;\n  margin: auto;\n}\n\n.headerslide {\n  background: #E31F21;\n  border-radius: 5px;\n  width: 50%;\n  text-align: center;\n  font-style: normal;\n  font-weight: 700;\n  font-size: 18px;\n  line-height: 130%;\n  text-align: center;\n  letter-spacing: -0.165px;\n  color: #FFFFFF;\n}\n\n.nama {\n  font-style: normal;\n  font-weight: 500;\n  font-size: 16px;\n  line-height: 24px;\n  letter-spacing: -0.165px;\n  color: #3D2C7C;\n  padding-top: 10px;\n}\n\n.noakaun {\n  font-style: normal;\n  font-weight: 700;\n  font-size: 16px;\n  line-height: 24px;\n  letter-spacing: -0.165px;\n  color: #3D2C7C;\n}\n\n.tunggakan {\n  font-style: normal;\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 24px;\n  letter-spacing: -0.165px;\n  color: #D23330;\n  padding-top: 10px;\n}\n\n.byrsblm {\n  font-style: normal;\n  font-weight: 400;\n  font-size: 14px;\n  line-height: 123%;\n  text-align: center;\n  letter-spacing: -0.165px;\n  color: #3D2C7C;\n}\n\n.showmore {\n  height: 16px;\n  width: 8px;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.buttunchart {\n  background-color: #3D2C7C;\n  height: 48px;\n  width: 100%;\n  border-radius: 10px;\n  margin: auto;\n  font-style: normal;\n  font-weight: 700;\n  font-size: 14px;\n  line-height: 21px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (".contain {\n  text-align: center;\n  vertical-align: middle;\n  padding: 20px 50px;\n}\n\n.card {\n  background: #FFFFFF;\n  border: 1px solid #F7FAFD;\n  box-sizing: border-box;\n  box-shadow: 0px 4px 8px rgba(73, 87, 184, 0.2);\n  border-radius: 17px;\n  height: 130px;\n  padding: 30px;\n}\n\n.icon {\n  height: 70px;\n  width: 70px;\n  display: inline-block;\n}\n\n.word {\n  font-style: normal;\n  font-weight: 600;\n  font-size: 14px;\n  line-height: 21px;\n  align-items: center;\n  text-align: center;\n  color: #494949;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/***/ 11443:
/*!************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/shared/modals/tambahakaun/tambahakaun.component.html ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<div class=\"contain\">\r\n  <div class=\"card\">\r\n    <table style=\"width: 100%;\" (click)=\"perumahan()\">\r\n      <tr>\r\n        <td style=\"width:30%;\"><img src=\"../../assets/icon/perumahan.png\" class=\"icon\"/></td>\r\n        <td>\r\n            <span class=\"word\">\r\n              {{akaun}}<br>{{jenis}}\r\n            </span>\r\n        </td>\r\n      </tr>\r\n    </table>\r\n  </div>\r\n  <div style=\"height: 15px;\"></div>\r\n  <div class=\"card\">\r\n    <table style=\"width: 100%;\" (click)=\"premis()\">\r\n      <tr>\r\n        <td style=\"width:30%;\"><img src=\"../../assets/icon/premis.png\" class=\"icon\"/></td>\r\n        <td>\r\n            <span class=\"word\">\r\n              {{akaun}}<br>{{jenis2}}\r\n            </span>\r\n        </td>\r\n      </tr>\r\n    </table>\r\n  </div>  \r\n</div>\r\n");
