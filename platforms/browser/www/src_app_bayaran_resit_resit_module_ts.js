...
let ResitPage = class ResitPage {
    ...
    ngOnInit() {
        // this.presentLoading()
        /* eslint-disable */ ;
        (oo_oo(), console.log("in resiiiiiittttt", `35406bba_0`));
    ...
    cetak(id) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            /* eslint-disable */ ;
            (oo_oo(), console.log(id, `35406bba_1`));
            ...
            yield this.pdfGenerator.fromData(content, options)
                .then((base64) => {
                /* eslint-disable */ ;
                (oo_oo(), console.log('OK', base64, `35406bba_2`));
            }).catch((error) => {
                /* eslint-disable */ ;
                (oo_oo(), console.log('error', error, `35406bba_3`));
            });
        });
    }
    presentLoading() {
