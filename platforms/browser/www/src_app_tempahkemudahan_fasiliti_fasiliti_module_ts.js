...
let FasilitiPage = class FasilitiPage {
    ...
    ngOnInit() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            this.TarikhVal = Date.now().toLocaleString();
    ...
    ionViewDidEnter() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.lokasiService.getdd().subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `f2231ebf_0`));
                this.ddLokasi = res;
                yield this.fasilitiService.getfutsal().subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
                    /* eslint-disable */ ;
                    (oo_oo(), console.log(res, `f2231ebf_1`));
                    this.listfutsal = res;
                    yield this.fasilitiService.getbadminton().subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
                        /* eslint-disable */ ;
                        (oo_oo(), console.log(res, `f2231ebf_2`));
                        ...
                        /* eslint-disable */ ;
                        (oo_oo(), console.log(res, `f2231ebf_5`));
                        yield loading.dismiss();
                        const alert = yield this.alertController.create({
                            header: 'Loading failed',
                            message: res.message,
                    ...
                    /* eslint-disable */ ;
                    (oo_oo(), console.log(res, `f2231ebf_6`));
                    yield loading.dismiss();
                    const alert = yield this.alertController.create({
                        header: 'Loading failed',
                        message: res.message,
                ...
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `f2231ebf_7`));
                yield loading.dismiss();
                const alert = yield this.alertController.create({
                    header: 'Loading failed',
                    message: res.message,
    ...
    ChangeDDFasiliti() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (this.Fasiliti == 1) {
                ...
                var val = this.Lokasi;
                /* eslint-disable */ ;
                (oo_oo(), console.log(val, `f2231ebf_8`));
    ...
    ChangeDDGelanggang() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
                ...
                if (fasiliti == 1) {
                    if (value.ft_court_id == gelanggang) {
                        if (value.days > 1) {
                            ...
                            /* eslint-disable */ ;
                            (oo_oo(), console.log(opt, `f2231ebf_9`));
                    ...
                    if (value.bd_court_id == gelanggang) {
                        if (value.days > 1) {
                            ...
                            var dateday = obj['date'];
                            /* eslint-disable */ ;
                            (oo_oo(), console.log(opt, `f2231ebf_10`));
                            for (let i = 1; i < value.days; i++) {
                                var obj = {};
                                dateday = new Date(dateday).getTime() + (1000 * 60 * 60 * 24);
                                var newdate = new Date(dateday);
            ...
            /* eslint-disable */ ;
            (oo_oo(), console.log(this.caloption, `f2231ebf_11`));
            if (this.cal == true) {
                this.cal = false;
            }
        });
    ...
    pilihcal() {
        /* eslint-disable */ ;
        (oo_oo(), console.log(this.date, `f2231ebf_12`));
        if (this.cal == true) {
            this.cal = false;
        }
        else {
    ...
    ChangeDDTarikh() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.listbooking.forEach(function (value) {
                return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
                    /* eslint-disable */ ;
                    (oo_oo(), console.log(value, `f2231ebf_13`));
                    if (fasiliti == 1) {
            ...
            /* eslint-disable */ ;
            (oo_oo(), console.log('alltime', alltime, `f2231ebf_14`));
            this.ChangeMasa(alltime);
        });
    }
    ChangeMasa(time) {
        /* eslint-disable */ ;
        (oo_oo(), console.log(time, `f2231ebf_15`));
        var txt;
        var txt2;
        var temp = [];
        var add = true;
        ...
        this.timecheck = temp;
        /* eslint-disable */ ;
        (oo_oo(), console.log(this.timecheck, `f2231ebf_16`));
    }
    hantar() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            const loading = yield this.loadingController.create();
            ...
            if (this.Fasiliti == 1) {
                ...
                /* eslint-disable */ ;
                (oo_oo(), console.log('timecheck', this.timecheck, `f2231ebf_17`));
                if (this.timecheck != []) {
                    /* eslint-disable */ ;
                    (oo_oo(), console.log(this.timecheck, `f2231ebf_18`));
                    var array = [];
                    yield this.timecheck.forEach(function (value) {
                        if (value.check == true) {
                            /* eslint-disable */ ;
                            (oo_oo(), console.log(value, `f2231ebf_19`));
                ...
                /* eslint-disable */ ;
                (oo_oo(), console.log('timecheck', this.timecheck, `f2231ebf_20`));
                if (this.timecheck != []) {
                    /* eslint-disable */ ;
                    (oo_oo(), console.log(this.timecheck, `f2231ebf_21`));
                    var array = [];
                    yield this.timecheck.forEach(function (value) {
                        if (value.check == true) {
                            /* eslint-disable */ ;
                            (oo_oo(), console.log(value, `f2231ebf_22`));
                            array.push(value.val);
                        }
                    });
                    this.masa = array.toString();
            ...
            /* eslint-disable */ ;
            (oo_oo(), console.log('masa', this.masa, `f2231ebf_23`));
            ...
            yield this.bookingService.add(formData).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `f2231ebf_24`));
                this.clearform();
                yield loading.dismiss();
                var arr = [];
                var akaun = {};
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `f2231ebf_25`));
                if (this.Fasiliti == 1) {
                    var kod = "FT" + res.id;
                }
                else if (this.Fasiliti == 2) {
                ...
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `f2231ebf_26`));
                yield loading.dismiss();
                const alert = yield this.alertController.create({
                    header: 'Loading failed',
                    message: res.message,
