...
let AlatanPage = class AlatanPage {
    ...
    pilihCal() {
        /* eslint-disable */ ;
        (oo_oo(), console.log(this.date, `b9c54a59_2`));
        if (this.cal === true) {
            this.cal = false;
        }
        else {
        ...
        if (fromdate.getDate() < 10) {
            /* eslint-disable */ ;
            (oo_oo(), console.log(date, `b9c54a59_3`));
        ...
        /* eslint-disable */ ;
        (oo_oo(), console.log(this.TarikhVal, `b9c54a59_4`));
    }
    increment() {
        this.QtyVal++;
    }
    ...
    hantar() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.bookingService.add(formData).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `b9c54a59_5`));
                this.clearform();
                yield loading.dismiss();
                var arr = [];
                var akaun = {};
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `b9c54a59_6`));
                akaun = {
                    id: '',
                    amaun: this.amaun,
                ...
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `b9c54a59_7`));
                yield loading.dismiss();
                const alert = yield this.alertController.create({
                    header: 'Loading failed',
                    message: res.message,
