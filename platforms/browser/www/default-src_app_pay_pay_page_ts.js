    ...
    pay() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.nativeStorage.getItem('user').then((u) => {
                ...
                /* eslint-disable */ ;
                (oo_oo(), console.log('referenceeeeee', ref, `9fef1c97_0`));
                /* eslint-disable */ ;
                (oo_oo(), console.log('subjecttt', this.paymentService.refId.value, `9fef1c97_1`));
                /* eslint-disable */ ;
                (oo_oo(), console.log("referenceee", `9fef1c97_2`));
                (oo_oo(), console.log(u.value, `9fef1c97_3`));
                ...
                browser.on('loadstop').subscribe((event) => {
                    /* eslint-disable */ ;
                    (oo_oo(), console.log(event, `9fef1c97_4`));
