...
let SemakbayaranPage = class SemakbayaranPage {
    ...
    ionViewDidEnter() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.nativeStorage.getItem('user').then(data => {
                /* eslint-disable */ ;
                (oo_oo(), console.log('akaun', data.value, `3227eb8_0`));
                ...
                if (rumah != undefined) {
                    rumah.forEach(element => {
                        ...
                        /* eslint-disable */ ;
                        (oo_oo(), console.log(temp2, `3227eb8_1`));
                ...
                if (premis != undefined) {
                    premis.forEach(element => {
                        ...
                        /* eslint-disable */ ;
                        (oo_oo(), console.log(temp2, `3227eb8_2`));
                        element.jumlahbyr = temp + temp2;
                        this.ddakaun.push(element);
                    });
                }
                /* eslint-disable */ ;
                (oo_oo(), console.log('rumah', rumah, `3227eb8_3`));
                /* eslint-disable */ ;
                (oo_oo(), console.log('premis', premis, `3227eb8_4`));
                /* eslint-disable */ ;
                (oo_oo(), console.log('allakaun', this.ddakaun, `3227eb8_5`));
                loading.dismiss();
    ...
    tukaracc(data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            /* eslint-disable */ ;
            (oo_oo(), console.log(data, `3227eb8_6`));
