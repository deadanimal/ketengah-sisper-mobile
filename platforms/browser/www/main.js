...
const routes = [
    ...
    {
        path: 'register',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_login_register_register_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./login/register/register.module */ 41408)).then(m => m.RegisterPageModule)
    },
    {
        path: 'forgotpass',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_login_forgotpass_forgotpass_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./login/forgotpass/forgotpass.module */ 85065)).then(m => m.ForgotpassPageModule)
    },
    {
        path: 'notis',
    ...
    {
        path: 'adminmenu',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_shared_modals_adminmenu_adminmenu_page_ts"), __webpack_require__.e("src_app_shared_modals_adminmenu_adminmenu_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./shared/modals/adminmenu/adminmenu.module */ 88698)).then(m => m.AdminmenuPageModule)
    },
    {
        path: 'lainlain',
    ...
    {
        path: 'firstime',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_firstime_firstime_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./firstime/firstime.module */ 93879)).then(m => m.FirstimePageModule)
    },
    {
        path: 'aduan',
    ...
    {
        path: 'lejard',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_shared_modals_lejard_lejard_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./shared/modals/lejard/lejard.module */ 85446)).then(m => m.LejardPageModule)
    }
];
...
/* harmony import */ var _ngx_translate_http_loader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ngx-translate/http-loader */ 40830);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.NgModule)({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_9__.BrowserModule, _angular_common__WEBPACK_IMPORTED_MODULE_10__.CommonModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_11__.IonicModule.forRoot({
                scrollAssist: false,
                scrollPadding: true
        ...
        providers: [_ionic_native_pdf_generator_ngx__WEBPACK_IMPORTED_MODULE_5__.PDFGenerator, _awesome_cordova_plugins_native_storage_ngx__WEBPACK_IMPORTED_MODULE_2__.NativeStorage, { provide: _angular_router__WEBPACK_IMPORTED_MODULE_14__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_11__.IonicRouteStrategy }, _angular_common__WEBPACK_IMPORTED_MODULE_10__.DatePipe, _awesome_cordova_plugins_keyboard_ngx__WEBPACK_IMPORTED_MODULE_4__.Keyboard],
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("ion-menu ion-content {\n  --background: var(--ion-item-background, var(--ion-background-color, #fff));\n}\n\nion-menu.md ion-content {\n  --padding-start: 8px;\n  --padding-end: 8px;\n  --padding-top: 20px;\n  --padding-bottom: 20px;\n}\n\nion-menu.md ion-list {\n  padding: 20px 0;\n}\n\nion-menu.md ion-note {\n  margin-bottom: 30px;\n}\n\nion-menu.md ion-list-header,\nion-menu.md ion-note {\n  padding-left: 10px;\n}\n\nion-menu.md ion-list#inbox-list {\n  border-bottom: 1px solid var(--ion-color-step-150, #d7d8da);\n}\n\nion-menu.md ion-list#inbox-list ion-list-header {\n  font-size: 22px;\n  font-weight: 600;\n  min-height: 20px;\n}\n\nion-menu.md ion-list#labels-list ion-list-header {\n  font-size: 16px;\n  margin-bottom: 18px;\n  color: #757575;\n  min-height: 26px;\n}\n\nion-menu.md ion-item {\n  --padding-start: 10px;\n  --padding-end: 10px;\n  border-radius: 4px;\n}\n\nion-menu.md ion-item.selected {\n  --background: rgba(var(--ion-color-primary-rgb), 0.14);\n}\n\nion-menu.md ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\n\nion-menu.md ion-item ion-icon {\n  color: #616e7e;\n}\n\nion-menu.md ion-item ion-label {\n  font-weight: 500;\n}\n\nion-menu.ios ion-content {\n  --padding-bottom: 20px;\n}\n\nion-menu.ios ion-list {\n  padding: 20px 0 0 0;\n}\n\nion-menu.ios ion-note {\n  line-height: 24px;\n  margin-bottom: 20px;\n}\n\nion-menu.ios ion-item {\n  --padding-start: 16px;\n  --padding-end: 16px;\n  --min-height: 50px;\n}\n\nion-menu.ios ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\n\nion-menu.ios ion-item ion-icon {\n  font-size: 24px;\n  color: #73849a;\n}\n\nion-menu.ios ion-list#labels-list ion-list-header {\n  margin-bottom: 8px;\n}\n\nion-menu.ios ion-list-header,\nion-menu.ios ion-note {\n  padding-left: 16px;\n  padding-right: 16px;\n}\n\nion-menu.ios ion-note {\n  margin-bottom: 8px;\n}\n\nion-note {\n  display: inline-block;\n  font-size: 16px;\n  color: var(--ion-color-medium-shade);\n}\n\nion-item.selected {\n  --color: var(--ion-color-primary);\n}\n\nion-modal .modal-wrapper {\n  height: 70%;\n  width: 60%;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
