...
let LainLainPage = class LainLainPage {
    ...
    hantar() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.lainService.add(this.lainform.value).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `efe2b307_2`));
                ...
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `efe2b307_3`));
                yield loading.dismiss();
                const alert = yield this.alertController.create({
                    header: 'Loading failed',
                    message: res.message,
    ...
    Check(val) {
        /* eslint-disable */ ;
        (oo_oo(), console.log(this.user.tender, `efe2b307_4`));
