...
/* harmony import */ var _confirm_pay_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./confirm-pay.component.scss */ 59214);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/core */ 37716);
...
let AduanService = class AduanService {
    ...
    getDropdown() {
        var accounts = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.baseUrl + "aduan?user_id=1";
...
let PerumahanService = class PerumahanService {
    ...
    kemaskini(id, data) {
        return this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.baseUrl + "perumahan/" + id, data);
    }
};
