    ...
    ngOnInit() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.nativeStorage.getItem('user').then(data => {
                ...
                /* eslint-disable */ ;
                (oo_oo(), console.log(this.ddakaun, `be9bdfdf_0`));
            ...
            /* eslint-disable */ ;
            (oo_oo(), console.log(this.ddYear, `be9bdfdf_1`));
            this.ddMonth = [{
                    "id": 1,
                    "name": "January"
                }, {
            ...
            /* eslint-disable */ ;
            (oo_oo(), console.log(this.ddMonth, `be9bdfdf_2`));
    ...
    hantar() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.bayaranService.lejar(formData).subscribe((res) => (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `be9bdfdf_3`));
                this.lejardtl = res;
                var data = {
                ...
                /* eslint-disable */ ;
                (oo_oo(), console.log(res, `be9bdfdf_4`));
                yield loading.dismiss();
